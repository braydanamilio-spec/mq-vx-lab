...
/* 9/9 — anh: *"nhân vật vật còn to che hơi nhiều và nên bố trí lại cho đẹp hợp lý ko bị che
...
const Panel: React.FC<{
  ...
  const kCan = khungDoc
    ...
    /* Khung 16:9: bề ngang là ràng buộc THẮNG (§17.2 — hình người cao gấp ba lần rộng, nên
