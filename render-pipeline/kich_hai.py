...
KENH = [
    {"ten": "RENT PANIC", "handle": "@rentpanicusa", "a": "nam_gay", "b": "bank",
     ...
     "nen": ["empty american apartment living room, bare walls, afternoon light",
             "apartment building lobby with mailboxes along one wall, warm lamps",
             "shared laundry room with washing machines along the back wall",
             "apartment hallway with numbered doors receding, ceiling lights"]},
    {"ten": "GYM LIES", "handle": "@gymliesusa", "a": "khoa_hoc", "b": "hang_xom",
     "mau": "#E3EEF6", "de": "gym",
     "nen": ["american gym floor with weight racks along the back wall, cool blue light",
             ...
             "gym stretching corner with foam rollers and yoga mats on the floor, plain painted wall behind",
             "locker room with a bench and lockers along the back wall",
             "empty spin studio with bikes pushed to the back wall"]},
    {"ten": "AIRPORT HELL", "handle": "@airporthellusa", "a": "luat_tre", "b": "y_ta",
     "mau": "#E8EDF4", "de": "airport",
     "nen": ["airport check-in hall with queue barriers, tall windows, overcast light",
             "airport departure gate lounge, planes outside the glass, dusk",
             "baggage claim hall with a carousel along the back, fluorescent light",
             "airport moving walkway corridor with tall windows"]},
    {"ten": "CAR GUY", "handle": "@carguyusa", "a": "hang_xom", "b": "vien_phi",
     "mau": "#EEE6D8", "de": "car",
     "nen": ["auto repair garage bay with tool chests along the back wall, warm work light",
             "american suburban driveway beside a parked car, morning",
             "tyre shop floor with stacked tyres along the back wall",
             "empty car dealership showroom floor, glass front, daylight"]},
    {"ten": "OFFICE SMALL TALK", "handle": "@officesmalltalkusa", "a": "vien_phi", "b": "cong_to",
     "mau": "#EDF1F6", "de": "office",
     "nen": ["office meeting room with a long table pushed to the back, glass wall, daylight",
             "office kitchenette with a counter along the back wall, warm light",
             "open plan office floor with desks along the back, late afternoon",
             "office corridor with a printer against the wall, ceiling lights"]},
    {"ten": "DIET WARS", "handle": "@dietwarsusa", "a": "bank", "b": "hang_xom",
     "mau": "#F6EDDC", "de": "diet",
     "nen": ["american home kitchen with counters along the back wall, bright morning light",
             "diner interior with red booths along the back wall, warm light",
             "farmers market stall with crates of fruit along the back",
             "backyard patio with a grill against the fence, afternoon"]},
    {"ten": "TECH SUPPORT", "handle": "@techsupportusa", "a": "luat_tre", "b": "khoa_hoc",
     "mau": "#E9E6F4", "de": "tech",
     "nen": ["american living room with a sofa against the back wall, evening lamp light",
             "call centre floor with cubicles along the back, cool light",
             "home office corner with a desk against the wall, soft daylight",
             "electronics repair shop counter along the back wall"]},
    {"ten": "PARENT MODE", "handle": "@parentmodeusa", "a": "hang_xom", "b": "sao_dem",
     "mau": "#F4E9DC", "de": "parent",
     "nen": ["american family living room with a worn couch against the wall, afternoon light",
             "suburban driveway beside a parked family car, morning",
             "teenager bedroom with posters on the back wall, string lights",
             "school pickup zone with a low wall and trees, afternoon"]},
    {"ten": "NEIGHBOR WATCH", "handle": "@neighborwatchusa", "a": "hang_xom", "b": "cong_to",
     "mau": "#F7EFD8", "de": "neighbor",
     "nen": ["american suburban backyard with a white picket fence across the back",
             "front porch of a suburban house, railing along the back, warm light",
             "quiet suburban street with mailboxes along the kerb, morning haze",
    ...
    {"ten": "DATING APP", "handle": "@datingappusa", "a": "sao_dem", "b": "luat_tre",
     ...
     "nen": ["small apartment living room with a couch against the back wall, evening lamp",
             "coffee shop interior with a counter along the back wall, window light",
             "quiet residential street at night, parked cars under street lamps",
             "rooftop terrace with a low wall and city skyline behind, dusk"]},
    {"ten": "DMV LINE", "handle": "@dmvlineusa", "a": "luat_tre", "b": "bank", "mau": "#E7E2D4", "de": "dmv", "nen": ["the DMV counter", "the waiting area", "the photo booth", "the eye test station"]},
    {"ten": "ER BILLING", "handle": "@erbillingusa", "a": "khoa_hoc", "b": "cong_to", "mau": "#EAF0F2", "de": "erbill", "nen": ["the billing window", "the hospital waiting room", "the discharge desk", "the insurance office"]},
    {"ten": "HOA RULES", "handle": "@hoarulesusa", "a": "hang_xom", "b": "cong_to", "mau": "#EFE9DC", "de": "hoa", "nen": ["the front lawn", "the driveway", "the mailbox row", "the community pool"]},
    {"ten": "RETURN POLICY", "handle": "@returnpolicyusa", "a": "sao_dem", "b": "tham_phan", "mau": "#F2E7DB", "de": "ret", "nen": ["the returns counter", "the customer service desk", "the checkout lane", "the aisle by electronics"]},
    {"ten": "WEDDING PLAN", "handle": "@weddingplanusa", "a": "bank", "b": "hang_xom", "mau": "#F6E9EE", "de": "wed", "nen": ["the venue hall", "the tasting table", "the florist counter", "the dress fitting room"]},
    {"ten": "MOVING DAY", "handle": "@movingdayusa", "a": "cong_to", "b": "luat_tre", "mau": "#EDE4D2", "de": "mov", "nen": ["the empty living room", "the moving truck ramp", "the front doorway", "the stairwell landing"]},
    {"ten": "VET VISIT", "handle": "@vetvisitusa", "a": "khoa_hoc", "b": "tham_phan", "mau": "#E6F0E8", "de": "vet", "nen": ["the exam room", "the vet waiting area", "the reception desk", "the scale corner"]},
    {"ten": "CABLE BILL", "handle": "@cablebillusa", "a": "hang_xom", "b": "sao_dem", "mau": "#E4E8F0", "de": "cab", "nen": ["the living room with the TV", "the cable box shelf", "the home office desk", "the call center row"]},
    {"ten": "SCHOOL RUN", "handle": "@schoolrunusa", "a": "bank", "b": "cong_to", "mau": "#F0EBDA", "de": "sch", "nen": ["the classroom door", "the school hallway", "the pickup line curb", "the front office"]},
    {"ten": "SELF CHECKOUT", "handle": "@selfcheckoutusa", "a": "luat_tre", "b": "khoa_hoc", "mau": "#E9EDE6", "de": "chk", "nen": ["the self checkout station", "the grocery aisle", "the produce section", "the bagging area"]},
]
...
# 1/9 (tiếp) — và chỗ hỏng NẶNG NHẤT không nằm ở hằng này mà ở BẢNG KÊNH phía trên: 10 kênh
# hài mới nhúng thẳng cả câu sàn vào từng mục `nen`, kèm đúng vế nghịch `no furniture blocking
# the middle`. Trong khi bộ dựng prompt VỐN ĐÃ tự nối `SAN_NEN` vào (`f"{canh}, {SAN_NEN}, …"`).
# Nên mỗi prompt của 10 kênh ấy chở câu sàn HAI LẦN, mà bản thứ hai là bản hỏng — và bản hỏng
# đứng sau nên nói tiếng nói cuối cùng. Đó là vì sao ảnh 10 kênh mới không có sàn.
# Nay bảng chỉ giữ MỆNH ĐỀ BỐI CẢNH ("the DMV counter"); luật sàn do `SAN_NEN` nói, một lần.

# Ép ảnh có SÀN ở một phần ba dưới khung — nếu không, ảnh chụp ngang tầm mặt bàn và nhân vật hoá
# ra đứng trên mặt bàn (luật 7aa).
#
# 1/9 — anh: *"ảnh không có sàn -> lơ lửng; ép sàn chiếm trọn phần ba dưới, đồ đạc dồn hai mép,
# giữa để trống."* Ba mệnh lệnh ĐÃ có trong câu này từ lâu, mà ảnh vẫn không ra sàn. Lý do nằm
# ở vế cuối của bản cũ: `no furniture blocking the middle`.
#
# FLUX KHÔNG CÓ NEGATIVE PROMPT. Mọi thứ viết ra đều là thứ NÊN xuất hiện. Bản cũ vì thế đọc
# thành "furniture, middle" — tôi tự tay dặn nó kê đồ chắn ngay giữa khung, và đồ ấy che mất
# đúng dải sàn mà câu trước vừa đòi. Y hệt vụ tiền tố `NO TEXT` khiến FLUX viết chữ "NO Text."
# lên sàn hồi 30/8: cùng một họ lỗi, tái phạm vì tôi sửa chỗ đó mà không rà những câu cấm khác.
#
# Nay cả bốn mệnh lệnh đều viết THUẬN — mô tả thứ muốn thấy, không mô tả thứ muốn cấm:
#   sàn liền một mạch trái sang phải · máy ngang tầm mắt · đồ dồn hai mép · giữa là sàn trống
SAN_NEN = ("wide shot, camera at standing eye level, "
           "the ground plane fills the entire bottom third of the frame as one continuous "
